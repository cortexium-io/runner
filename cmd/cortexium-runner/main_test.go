...
func TestInitInteractivelyCollectsMissingRequiredChoices(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"planner: claude · model claude-opus-5-5 · reasoning xhigh",
		"implementer: claude · model claude-opus-5-5 · reasoning xhigh · access sandboxed · harness config isolated · task sizing small",
...
func TestEveryCommandHelpReturnsSuccess(t *testing.T) {
	commands := [][]string{
		{"init", "--help"}, {"doctor", "--help"}, {"update", "--help"}, {"plan", "--help"}, {"approve", "--help"}, {"retry", "--help"}, {"status", "--help"}, {"run", "--help"}, {"stop", "--help"},
